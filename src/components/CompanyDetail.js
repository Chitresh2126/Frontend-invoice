        ...
        <form action="">
            ...
            <div id="companyName" className="flex flex-row ">
                    ...
                    <div id="companyName" className="w-1/2 mr-2">
                        <label for="cname" className="text-sm">Company/Sender name*</label><br />
                    ...
                    <div id="cNumber" className="w-1/2 ml-2 ">
                        <label  className="text-sm lastnameLabel" contenteditable="true">Tax Registration no.</label><br />
              ...
              <div id="detail" className="flex flex-row ">
                    ...
                    <div id="place" className="w-1/2 mr-2">
                        <label for="country" className="text-sm">Country</label><br />
              ...
              <div id="link" className="flex flex-row ">
                    ...
                    <div id="mail" className="w-1/2 mr-2 ">
                        <label for="mailEmail" className="text-sm">Email</label><br />
                        <input type="email" name="" id="mailEmail"
                            className="h-8 w-full rounded-md border border-slate-300 text-sm pl-2 bg-transparent    
                            outline-blue-600 shadow-sm" required/>
                    </div>
                    {/* <!-- last name --> */}
                    <div id="site" className="w-1/2 ml-2 ">
